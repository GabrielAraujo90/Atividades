...
class NovaJanela(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle("Santos o maior do Brasil")
        self.setGeometry(100, 100, 300, 200)

       
        self.nome_label = QLabel("Nome:")
        self.nome_input = QLineEdit()
        self.mensagem_label = QLabel("O palmeiras tem mundial ??")
        self.mensagem_input = QTextEdit()

        
        self.botao_enviar = QPushButton("Claro Que Não (Enviar)")
...
if __name__ == '__main__':
    ...
    nova_janela.setStyleSheet("background-color: lightgreen;")
    nova_janela.show()
